...
import { Upload, FileText, Loader2, CheckCircle, AlertCircle, Download, Filter, X } from 'lucide-react';
...
const Processor: React.FC<ProcessorProps> = ({ config, processedIds, onProcessComplete, history }) => {
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              {filteredHistory.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-8 text-center text-slate-400 bg-slate-50/50">
